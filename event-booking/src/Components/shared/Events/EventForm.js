  ...
  return (
    ...
    >
      ...
      <div container className="flex flex-col justify-center ">
        ...
        <div className="flex mt-4" style={{ position: "absolute", top: "0" }}>
          <DateRangePicker
        ...
        <div className="flex mt-4">
            ...
            InputProps={{
              startAdornment: (
                <InputAdornment position="start">
                  <DateRangeSharpIcon onClick={toggle} />
                </InputAdornment>
              ),
              endAdornment: chipData.map((data) => {
                return (
                  <Chip
                    label={`Day (${moment(data.label?.startDate).format(
                      "L"
                    )}-${moment(data.label?.endDate).format("L")})`}
                  />
                );
              }),
            }}
          ...
          {/* {chipData.map((data) => {
            console.log(moment(data.label?.startDate).format("L"));
