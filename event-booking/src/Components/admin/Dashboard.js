...
const AdminDashboard = (props) => {
  ...
  const renderContent = () => {
    ...
    switch (contentComponent) {
      case "dashboard":
        return <div><Adminnew /></div>
      case "event":
        return <div><AEvents /></div>
        case "user":
        return <div><Userlist /></div>
        case "organiser":
        return <div><Organiserlist /></div>
    }
  }
      ...
      <main className={classes.content}>
        ...
        <Container maxWidth="lg" className={classes.container}>
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} md={4} lg={3}>
              <Paper className={fixedHeightPaper}>
                <Custompanel title="Organizers" count={3} actionText="view" />
              </Paper>
            </Grid>
            <Grid item xs={12} md={4} lg={3}>
              <Paper className={fixedHeightPaper}>
                <Custompanel title="Events" count={3} actionText="view" />
              </Paper>
            </Grid>
            <Grid item xs={12} md={4} lg={3}>
              <Paper className={fixedHeightPaper}>
                <Custompanel title="Users" count={3} actionText="view" />
              </Paper>
            </Grid>
            {/* Recent Orders */}
            <Grid item xs={12}>
